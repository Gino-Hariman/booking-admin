  ...
  return (
    <div className="flex relative items-center">
      <input
        ...
        onClick={onClick}
      />
      <div className="checkbox bg-shade-FG rounded-1 border-2 rounded-md border-gray-700 w-6 h-6 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-primary-500">
        <CheckIcon className="icon hidden fill-current  w-4 h-4 text-primary-600 pointer-events-none " />
      </div>
      <label
        className="form-check-label text-md-3 font-medium text-center inline-block text-gray-700"
